...
@interface MealtimerNoXMLObject : KrollCoverageObject {
#else
@interface MealtimerNoXMLObject : KrollObject {
#endif
@private
...
extern NSString * MealtimerNoXML$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MealtimerNoXMLObject *_mealtimernoxml;
    KrollObject* console;
	BOOL shutdown;
