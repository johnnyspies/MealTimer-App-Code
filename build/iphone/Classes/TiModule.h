...
/**
 The base class for all MealtimerNoXML modules
 */
...
/**
 MealtimerNoXML Platform calls this method on startup.
 */
-(void)startup;

/**
 MealtimerNoXML Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MealtimerNoXML Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MealtimerNoXML Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MealtimerNoXML Platform calls this method on resume.
 @param sender The sender of the event.
 */
