...
/**
 Base class for all MealtimerNoXML views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MealtimerNoXML view hierarchy (such as wrapped iOS UIViews) was touched.
