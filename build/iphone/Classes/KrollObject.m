...
//@interface MealtimerNoXMLObject : NSObject
//@end

@interface MealtimerNoXMLObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MealtimerNoXMLObject class]])
		{
			for (NSString *key in [[(MealtimerNoXMLObject*)o modules] allKeys])
			{
