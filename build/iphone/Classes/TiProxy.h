...
//Rare exceptions to indicate a bug in the _mealtimernoxml code (Eg, function that a subclass should have implemented)
...
/**
 The base class for MealtimerNoXML proxies.
 */
