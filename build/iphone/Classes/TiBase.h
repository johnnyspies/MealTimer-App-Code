...
// in simulator we redefine to format for MealtimerNoXML Developer console
...
{\
	NSString * exceptionName = [@"org.mealtimernoxml." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mealtimernoxml";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMealtimerNoXMLNativeItemNone = -1, 
	UIMealtimerNoXMLNativeItemSpinner = -2,
	UIMealtimerNoXMLNativeItemProgressBar = -3,
	
	UIMealtimerNoXMLNativeItemSlider = -4,
	UIMealtimerNoXMLNativeItemSwitch = -5,
	UIMealtimerNoXMLNativeItemMultiButton = -6,
	UIMealtimerNoXMLNativeItemSegmented = -7,
	
	UIMealtimerNoXMLNativeItemTextView = -8,
	UIMealtimerNoXMLNativeItemTextField = -9,
	UIMealtimerNoXMLNativeItemSearchBar = -10,
	
	UIMealtimerNoXMLNativeItemPicker = -11,
	UIMealtimerNoXMLNativeItemDatePicker = -12,
	
	UIMealtimerNoXMLNativeItemInfoLight = -13,
	UIMealtimerNoXMLNativeItemInfoDark = -14,
	
	UIMealtimerNoXMLNativeItemDisclosure = -15,
	
	UIMealtimerNoXMLNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MealtimerNoXML instances of
